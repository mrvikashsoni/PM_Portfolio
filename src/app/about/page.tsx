...
const randomFacts = [
  "3+ years of experience in the Non-tech industry",
      ...
      <main className="flex-1 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16 flex flex-col md:flex-row gap-12 items-start">
            {/* Avatar */}
            <div className="shrink-0 relative w-36 h-36 rounded-full overflow-hidden shadow-xl ring-4 ring-white">
              <Image
                src="/profile.png"
                alt="Vikash Kumar"
                fill
            ...
            <div>
              ...
              <div className="prose prose-gray max-w-none text-gray-600 text-base leading-relaxed space-y-4">
                <p>
                  An enterprising AI-augmented CTO and Senior Tech Project Manager with over 5 years of experience orchestrating end-to-end technical strategy, microservices architecture, and high-velocity product delivery for enterprise-grade SaaS and E-commerce solutions. Highly adept at leveraging advanced generative AI ecosystems—including Claude, ChatGPT, and Gemini—to expedite codebase architecture, optimize technical debt, and supercharge engineering workflows. Demonstrates a proven track record of seamlessly bridging macro business objectives with micro technical execution, driving continuous integration and rapid deployment pipelines across complex cloud-native environments.
                </p>
